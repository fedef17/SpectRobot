...
!     &           QT_grid    ! vector of internal partition sum tabulated at different temperatures
!     &          )

      Subroutine bd_tips_2003(MOL, ISO, gi, t_grid, QT_grid)
...
!      implicit DOUBLE PRECISION (a-h,o-z)
      real*8 tdat(119)
      integer*4 MOL, ISO
      real*8 gi, Q, QT_grid(119), t_grid(119)
Cf2py intent(in) MOL, ISO
Cf2py intent(out) gi, t_grid, QT_grid
...
C     GO TO PARTICULAR MOLECULE:
      ...
      IF(MOL.EQ.1) THEN
      CALL QT_H2O(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.2) THEN
      CALL QT_CO2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.3) THEN
*      write(*,*)'O3'
      CALL QT_O3(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.4) THEN
      CALL QT_N2O(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.5) THEN
      CALL QT_CO(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.6) THEN
      CALL QT_CH4(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.7) THEN
      CALL QT_O2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.8) THEN
      CALL QT_NO(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.9) THEN
      CALL QT_SO2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.10) THEN
      CALL QT_NO2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.11) THEN
      CALL QT_NH3(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.12) THEN
      CALL QT_HNO3(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.13) THEN
      CALL QT_OH(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.14) THEN
      CALL QT_HF(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.15) THEN
      CALL QT_HCL(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.16) THEN
      CALL QT_HBR(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.17) THEN
      CALL QT_HI(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.18) THEN
      CALL QT_CLO(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.19) THEN
      CALL QT_OCS(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.20) THEN
      CALL QT_H2CO(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.21) THEN
      CALL QT_HOCL(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.22) THEN
      CALL QT_N2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.23) THEN
      CALL QT_HCN(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.24) THEN
      CALL QT_CH3CL(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.25) THEN
      CALL QT_H2O2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.26) THEN
      CALL QT_C2H2(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.27) THEN
      CALL QT_C2H6(ISO,gi,QT_grid)
      go to 100
      ENDIF
C
      IF(MOL.EQ.28) THEN
      CALL QT_PH3(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.29) THEN
      CALL QT_COF2(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.30) THEN
      CALL QT_SF6(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.31) THEN
      CALL QT_H2S(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.32) THEN
      CALL QT_HCOOH(ISO,gi,QT_grid)
      go to 100
      ENDIF
!?c
      IF(MOL.EQ.33) THEN
      CALL QT_HO2(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
c      IF(MOL.EQ.34) THEN
...
!?c
      IF(MOL.EQ.35) THEN
      CALL QT_CLONO2(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.36) THEN
      CALL QT_NOp(ISO,gi,QT_grid)
      go to 100
      ENDIF
c
      IF(MOL.EQ.37) THEN
      CALL QT_HOBr(ISO,gi,QT_grid)
      go to 100
      ENDIF
!?c
      IF(MOL.EQ.38) THEN
      CALL QT_C2H4(ISO,gi,QT_grid)
      go to 100
      ENDIF
!?c
! HDO e' la numero 39
!      IF(MOL.EQ.39) THEN
!      CALL QT_H2O(Temp,4,gi,QT)
!      go to 100
!      ENDIF
!?c
      IF(MOL.EQ.40) THEN
!      CALL QT_BrO(ISO,gi,QT_grid)
      go to 100
      ENDIF

      IF(MOL.EQ.41) THEN
      CALL QT_C2N2(ISO,gi,QT_grid)
      go to 100
      ENDIF

      IF(MOL.EQ.42) THEN
      CALL QT_H3P(gi,QT_grid)
      go to 100
      ENDIF
...
c      include 'BD_MOL.FOR'
c      include 'BD_ISO_2002.FOR'
...
!! @VERSION     1.0
!- history:                                                                 !
!---date of creation: 14.03.2003                                            !
!                                                                           !
!---------------------------------------------------------------------------!
!!    @SUBJECT H2O partition function
!                                                                           !
!---------------------------------------------------------------------------!

      Subroutine QT_H2O(iso, gsi, Q)
!     I T, 	! temperature in K
!     I iso, 	! isotope code (HITRAN INDEX)
!     O gsi, 	! state independent nuclear degeneracyfactor
!     O Q) 	! Total Internal Partition Function tabulated

Cf2py intent(in) iso
Cf2py intent(out) gsi, Q
...
!! @INPUT_VARIABLES
      ...
      INTEGER*4         iso !! isotope code (HITRAN INDEX)

!! @OUTPUT_VARIABLES
      DOUBLE PRECISION  gsi !! state independent nuclear degeneracyfactor
      DOUBLE PRECISION  QT  !! Total Internal Partition Function

!! @INTERNAL_VARIABLES
      dimension xgj( 6), QofT( 6,119),Q(119)
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj( 9), QofT( 9,119),Q(119)
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj(18), QofT(18,119),Q(119)
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj( 5), QofT( 5,119),Q(119)
      data xgj/ 9.,6.,6.,9.,54. /
c...      N2O
c...        --       446
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj( 3), QofT( 3,119),Q(119)
      data xgj/ 1.,2.,3./
c...      CH4
c...        --       211
...
Cf2py intent(out) gsi, Q
      ...
      COMMON/Temperatures/tdat
*e qui aggiungo i 2 nuovi isotopi e metto per ora fparts = a quella
*e dell'isotopo 2
      dimension xgj( 4), QofT( 4,119),Q(119)
      data xgj/ 1.,1., 1., 1./
c...      SO2
c...        --       626
...
c....       --  628
      data (QofT( 3,J),J=1,119)/ 0.53140E+03, 0.89578E+03, 0.13199E+04,
     + 0.17997E+04, 0.23353E+04, 0.29288E+04, 0.35837E+04, 0.43043E+04,
     + 0.50953E+04, 0.59621E+04, 0.69104E+04, 0.79465E+04, 0.90772E+04,
     + 0.10310E+05, 0.11651E+05, 0.13110E+05, 0.14694E+05, 0.16413E+05,
     + 0.18274E+05, 0.20289E+05, 0.22465E+05, 0.24814E+05, 0.27345E+05,
...
c....       --  636
      data (QofT( 4,J),J=1,119)/ 0.53140E+03, 0.89578E+03, 0.13199E+04,
     + 0.17997E+04, 0.23353E+04, 0.29288E+04, 0.35837E+04, 0.43043E+04,
     + 0.50953E+04, 0.59621E+04, 0.69104E+04, 0.79465E+04, 0.90772E+04,
     + 0.10310E+05, 0.11651E+05, 0.13110E+05, 0.14694E+05, 0.16413E+05,
     + 0.18274E+05, 0.20289E+05, 0.22465E+05, 0.24814E+05, 0.27345E+05,
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj( 1), QofT( 1,119),Q(119)
      data xgj/ 3./
c...      NO2
c...        --       646
...
Cf2py intent(out) gsi, Q
      ...
      dimension xgj( 2), QofT( 2,119),Q(119)
      data xgj/ 3.,2./
c...      NH3
c...        --      4111
...
c
c     *****************
      Subroutine QT_ClONO2(iso, gsi, Q)
Cf2py intent(in) iso
Cf2py intent(out) gsi, Q
...
c...     C2N2
c...        --      2244
      data (QofT( 1,J),J=1,119)/ 0.45602E+05, 0.45602E+05, 0.45602E+05,
     + 0.45602E+05, 0.45602E+05, 0.45602E+05, 0.45602E+05, 0.45602E+05,
     + 0.45602E+05, 0.45603E+05, 0.45603E+05, 0.45605E+05, 0.45608E+05,
     + 0.45614E+05, 0.45622E+05, 0.45634E+05, 0.45651E+05, 0.45674E+05,
     + 0.45705E+05, 0.45743E+05, 0.45790E+05, 0.45846E+05, 0.45914E+05,
     + 0.45992E+05, 0.46083E+05, 0.46185E+05, 0.46301E+05, 0.46429E+05,
     + 0.46570E+05, 0.46725E+05, 0.46892E+05, 0.47073E+05, 0.47266E+05,
     + 0.47472E+05, 0.47690E+05, 0.47920E+05, 0.48162E+05, 0.48415E+05,
     + 0.48680E+05, 0.48954E+05, 0.49239E+05, 0.49534E+05, 0.49838E+05,
     + 0.50150E+05, 0.50471E+05, 0.50800E+05, 0.51137E+05, 0.51480E+05,
     + 0.51831E+05, 0.52187E+05, 0.52549E+05, 0.52917E+05, 0.53290E+05,
     + 0.53668E+05, 0.54050E+05, 0.54436E+05, 0.54826E+05, 0.55219E+05,
     + 0.55615E+05, 0.56015E+05, 0.56416E+05, 0.56820E+05, 0.57226E+05,
     + 0.57634E+05, 0.58043E+05, 0.58454E+05, 0.58865E+05, 0.59278E+05,
     + 0.59691E+05, 0.60105E+05, 0.60519E+05, 0.60933E+05, 0.61348E+05,
     + 0.61762E+05, 0.62176E+05, 0.62590E+05, 0.63003E+05, 0.63415E+05,
     + 0.63827E+05, 0.64238E+05, 0.64648E+05, 0.65057E+05, 0.65465E+05,
     + 0.65872E+05, 0.66277E+05, 0.66681E+05, 0.67084E+05, 0.67485E+05,
     + 0.67884E+05, 0.68282E+05, 0.68678E+05, 0.69073E+05, 0.69466E+05,
     + 0.69857E+05, 0.70246E+05, 0.70633E+05, 0.71019E+05, 0.71402E+05,
     + 0.71784E+05, 0.72163E+05, 0.72541E+05, 0.72916E+05, 0.73290E+05,
     + 0.73661E+05, 0.74030E+05, 0.74398E+05, 0.74763E+05, 0.75126E+05,
     + 0.75486E+05, 0.75845E+05, 0.76202E+05, 0.76556E+05, 0.76908E+05,
     + 0.77258E+05, 0.77606E+05, 0.77952E+05, 0.78296E+05, 0.78637E+05,
     + 0.78976E+05/
...
c***************************
      ...
      subroutine QT_H3P_oneT(Temp,gi,q)
Cf2py intent(in) Temp
Cf2py intent(out) gi, q

C     This routine calculates the partition function for H3+ from the
C     Miller et al. (2010) fit in the temperature range 100:10000 K.
C     All the first principles levels are considered, more the
C     effective Hamiltonian.
C     The routine calculates also the derivative respect to the
C     temperature.
...
C     Internal
      ...
      if(temp.ge.100.0d0.and.temp.lt.1800.0d0) then
        a0 = -1.11391d0
        a(1) = 0.0581076d0
        a(2) = 0.000302967d0
        a(3) = -2.83724d-7
        ...
        a(5) = -7.15895d-14
        a(6) = 1.00150d-17
      elseif(temp.ge.1800.0d0.and.temp.lt.5000.0d0) then
        a0 = -22125.5d0
        a(1) = 51.1539d0
        a(2) = -0.0472256d0
        a(3) = 2.26131d-5
        ...
        a(5) = 7.90879d-13
        a(6) = -4.28349d-17
      elseif(temp.ge.5000.0d0.and.temp.le.10000.0d0) then
        a0 = -654293.0d0
        a(1) = 617.630d0
        a(2) = -0.237058d0
        a(3) = 4.74466d-5
        ...
        write(*,*) 'The partition function is set to q = 1.'
        write(*,*) 'The derivative dq/dt is set to 1.d-9.'
        q = 1.0d0
        return
      end if

C     q is given by: a(0) + a(1)*temp + ... + a(6)*temp^6

      rsum = a0
      do j = 1, 6
        rsum = rsum + a(j)*(temp**j)
      end do
...
C     Internal
      ...
      do i=1,119
        call QT_H3P_oneT(tdat(i),gi,q(i))
      enddo
